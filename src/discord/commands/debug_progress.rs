...
impl DebugProgressCommand {
    ...
    async fn demo_progress_bar(&self, msg: &Message, ctx: &Context) -> String {
        ...
        progress_reporter
            .set_status("Starting demo update...".to_string())
            .await;
        ...
        progress_reporter
            .set_status("Creating implementation plan...".to_string())
            .await;
        ...
        progress_reporter
            ...
            .await;
        progress_reporter
            .set_status("Creating git snapshot...".to_string())
            .await;
        ...
        progress_reporter
            .set_status("Implementing changes...".to_string())
            .await;
        ...
        for i in 1..=3 {
            ...
            progress_reporter
                .set_status(format!("Implementing task {i} of 5..."))
                .await;
        }
        ...
        progress_reporter
            .set_status("Running validation pipeline...".to_string())
            .await;
        ...
        progress_reporter.increment_tasks_completed().await;
        progress_reporter
            .set_status("Validating implementation...".to_string())
            .await;
        ...
        progress_reporter.increment_tasks_completed().await;
        progress_reporter
            .set_status("Final checks...".to_string())
            .await;
        ...
        progress_reporter
            .set_status("Demo completed successfully!".to_string())
            .await;
